...
//
// Everything RainyDay is lives in a static library, which exports the three
...
bool rainydayEntryInit(const char *pluginPath);
void rainydayEntryDeinit();
const void *rainydayEntryGetFactory(const char *factoryId);
}
